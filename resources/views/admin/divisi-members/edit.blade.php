        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="display-6 fw-bold mb-2">
                    <i class="bi bi-pencil-square me-3"></i>Edit Anggota Divisi
                </h1>
                <p class="lead mb-0">Perbarui informasi anggota "{{ $divisiMember->name }}"</p>
            </div>
            ...
            <div class="col-lg-8">
                <div class="form-card bg-white rounded-4 shadow-lg p-5">
                    <div class="form-header text-center mb-4">
                        ...
                        <h3 class="fw-bold text-primary mb-2">Form Edit Anggota</h3>
                        <p class="text-muted">Perbarui informasi anggota yang dipilih</p>
                    </div>

                    <form action="{{ route('divisi-members.update', $divisiMember) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="divisi_id" value="{{ $divisiMember->divisi_id }}">
